...
<div class="container">
    <div class="col-md-12 default-container">
        <h1>Beheerder
            toevoegen<?= $this->Html->link("Terug", ['action' => 'index'], ['class' => 'btn btn-primary btn-lg pull-right']) . ' '; ?></h1>
        <hr>
        ...
        <div class="hidden">
            <div class="hidden">
                <?= $this->Form->input('account_type', ['type' => 'hidden', 'value' => '2', 'required']); ?>
                <div class="help-block with-errors"></div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <?= $this->Form->input('password', ['type' => 'password', 'id' => 'password', 'class' => 'form-control ', 'div' => false, 'label' => false, 'required']); ?>
                <div class="help-block with-errors"></div>
            </div>
        </div>
        <hr>
