...
<div class="container">
    <div class="col-md-12 default-container">
        <h1>
            Details: <?= $manager->firstname . " " . $manager->lastname ?><?= $this->Html->link("Terug", ['action' => 'index'], ['class' => 'btn btn-primary btn-lg pull-right']) . ' '; ?></h1>
        <hr>
        <br>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tr>
                    <td><strong>Aanhef</strong></td>
                    <td><?= $manager->salution ?></td>
                </tr>
                <tr>
